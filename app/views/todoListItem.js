define(['jquery', 'underscore', 'backbone', 'common', 'text!templates/todoListItem.html'], 
  function($, _, Backbone, Common, TodoListItemTemplate){

  'use strict';

  var TodoItemView = Backbone.View.extend({
    tagName: 'li',
    template: _.template(TodoListItemTemplate),
    initialize: function(){
